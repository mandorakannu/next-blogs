...
export const CategoriesBasedBlog = async ({
  ...
  return (
    <>
      <section
        className={twMerger(
          "flex flex-row justify-around items-center max-sm:mx-10 sm:mx-20 py-10",
          flexProps
        )}
      >
        <div className="grid isolate group overflow-hidden place-items-center">
          ...
          <div className="flex flex-col justify-center items-center text-white text-center z-10 row-span-full col-span-full px-5">
            ...
            <Link
              className="max-sm:text-xl text-2xl text-center group-hover:underline underline-offset-2 font-bold line-clamp-3"
